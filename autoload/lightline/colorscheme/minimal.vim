...
" Author: Cody Stringham
" License: MIT License
" Last Change: 2018/12/19 21:53:01.
" =============================================================================

" Common colors
let s:fg     = [ '#abb2bf', 145 ]
let s:blue   = [ '#61afef', 75 ]
let s:green  = [ '#BDF271', 76 ]
...
let s:p.normal.left     = [ [ s:bg, s:gray1, 'bold' ], [ s:fg, s:gray3 ] ]
...
" Common
let s:p.normal.right   = [ [ s:bg, s:gray1, 'bold' ], [ s:bg, s:gray1, 'bold' ] ]
...
let s:p.visual.right   = [ [ s:bg, s:blue, 'bold' ], [ s:bg, s:blue, 'bold' ] ]
